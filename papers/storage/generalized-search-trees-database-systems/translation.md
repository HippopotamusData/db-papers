...
![图 1](assets/gist-fig01-search-tree.png)

图 1：数据库搜索树示意图。内部节点充当目录，叶节点形成链表。
...
![图 2](assets/gist-fig02-performance-factors.png)

图 2：影响 GiST 性能的因素空间。无重复数据上的 B+-树位于数据重叠与压缩损失都为 0 的原点。
...
![图 3](assets/gist-fig03-performance-surface.png)

图 3：参数空间中的性能。竖轴为平均 I/O 数。
