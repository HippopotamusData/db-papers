...
\frac{E(c\char"005F{}age\cdot \mathbf{1} _ {c\char"005F{}region=\text{'EU'}})}{P(c\char"005F{}region=\text{'EU'})}
...
$$
|C|\cdot E(\mathbf{1} _ {c\char"005F{}region=\text{'EU'}})=3\cdot\frac{2}{3}=2.
$$
...
\mathbf{1} _ {c\char"005F{}region=\text{'EU'}}\cdot N_C\right)
...
$$
\underbrace{|C|\cdot E(\mathbf{1} _ {c\char"005F{}region=\text{'EU'}}\cdot F _ {C\leftarrow O})} _ {Q_L}
\cdot
\underbrace{E(\mathbf{1} _ {o\char"005F{}channel=\text{'ONLINE'}})} _ {Q_R}
...
$$
|O|\cdot E(\mathbf{1} _ {o\char"005F{}channel=\text{'ONLINE'}})\cdot
\frac{E(\mathbf{1} _ {c\char"005F{}region=\text{'EU'}}\cdot F _ {C\leftarrow O}\mid F _ {C\leftarrow O}\gt{}0)}
...
$$
\frac{E\left(\frac{c\char"005F{}age}{F' _ {C\leftarrow O}}\mid c\char"005F{}region=\text{'EU'}\right)}
{E\left(\frac{1}{F' _ {C\leftarrow O}}\mid c\char"005F{}region=\text{'EU'}\right)}
