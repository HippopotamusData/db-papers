...
$$
 ...
 $P_{Eq}$ 由查询中的所有列等值谓词组成， $P_{Rq}$ 包含范围谓词， $P_{Uq}$ 是由 $W_q$ 其余所有合取项组成的残余谓词。 $W_v$ 也按相同方式划分。列等值谓词是形如 $(T_i.C_p=T_j.C_r)$ 的原子谓词，其中 $C_p$ 和 $C_r$ 是列引用。范围谓词是形如 $(T_i.C_p\ \mathrm{op}\ c)$ 的原子谓词，其中 $c$ 是常量， $\mathrm{op}$ 是“ $\lt{}$”“ $\le$”“ $=$”“ $\ge$”“ $\gt{}$”之一。该蕴含测试可拆分成三个独立测试：
