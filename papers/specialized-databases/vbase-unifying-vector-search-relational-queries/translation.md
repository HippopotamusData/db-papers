...
$$
r_1=\mathrm{Limit}\relax_K(\mathrm{Filter}(\mathrm{Limit}\relax_{K'}(\mathrm{Sort}(R_1)))). \tag{4}
$$
...
$$
\begin{aligned}
r_1&=\mathrm{Limit}\relax_{K''}(\mathrm{Filter}(\mathrm{Sort}(R_1))),\\
...
$$
r_1=\mathrm{Limit}\relax_K(\mathrm{Filter}(\mathrm{Sort}(R_1))). \tag{6}
$$

VBASE 用同一索引遍历 $R_2$：

$$
r_2=\mathrm{Limit}\relax_K(\mathrm{Sort}(\mathrm{Filter}(R_2))). \tag{7}
$$
...
$$
r_1=\mathrm{Filter}(\mathrm{Limit}\relax_{K'}(\mathrm{Sort}(R_1))). \tag{8}
$$
...
$$
r_1=\mathrm{Limit}\relax_T(\mathrm{Filter}(\mathrm{Sort}(R_1)))=\mathrm{Filter}(\mathrm{Sort}(R_1)). \tag{10}
$$
...
$$
\mathrm{Sel}\relax_{sample}(q)\approx\mathrm{Sel}\relax_{full\char"005F{}data}(q).
$$
